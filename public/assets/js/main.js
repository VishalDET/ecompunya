(function ($) {
	...
	***********************/
	...
	$(".handBurger").on("click", function () {
		$(".navOptions .innerNavOption ul").addClass("active")
	})
	$(".closeBtn").on("click", function () {
		$(".navOptions .innerNavOption ul").removeClass("active")
	})

	$(".galleryImg img").on("click", function () {
		var ImgSrc = $(this).attr("src")
		$(".previewImg").addClass("active")
		$(".innerPreviewImg img").attr("src", ImgSrc)
	...
	// My Account
	$(".mainMyAccountSection ul li").on("click", function () {
		let panelToShow = $(this).attr("rel")
		$(this).addClass("active").siblings().removeClass("active")

		$('.mainMyAccountSection .accountDetails .panel.active').fadeOut(500, function () {
	...
	$('.clickToAdd').on('click', function () {
		$('.addedToCart').addClass('animateShow');
		setTimeout(() => {
			$('.addedToCart').removeClass('animateShow')
		}, 2000);
	})
